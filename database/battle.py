...
class DB_battle:
    ...
    def get_win_counts(
        ...
        for poke in pokemonList:
            ...
            win = cur.fetchone()[0]
            counts.append((win, match))
        return counts

    @staticmethod
    def get_oppo_chosen_counts(
        pokemonList,
        from_date,
        to_date,
        rule: int = 1,
        ...
        for poke in pokemonList:
            ...
            counts.append((chosen, match))
        return counts

    @staticmethod
    def get_oppo_first_chosen_counts(
        pokemonList,
        from_date,
        to_date,
        rule: int = 1,
        ...
        for poke in pokemonList:
            ...
            counts.append((first, match))
        return counts

    @staticmethod
    def get_oppo_chosen_and_win_counts(
        pokemonList,
        from_date,
        to_date,
        rule: int = 1,
        ...
        for poke in pokemonList:
            ...
            win = cur.fetchone()[0]
            counts.append((win, chosen))
        return counts

    @staticmethod
    def get_oppo_first_chosen_and_win_counts(
        pokemonList,
        from_date,
        to_date,
        rule: int = 1,
