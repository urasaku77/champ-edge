...
a = Analysis(
    ...
    datas=[
        ...
        # stats: データファイルのみ（.pyはhiddenimportsでコンパイル済み）
        ('stats/ranking.json',      'stats'),
        ('stats/ranking.txt',       'stats'),
        ('stats/season.txt',        'stats'),
        ('stats/last_update.txt',   'stats'),
        ('stats/home_waza.csv',     'stats'),
        ('stats/home_tokusei.csv',  'stats'),
        ('stats/home_motimono.csv', 'stats'),
        ('stats/home_seikaku.csv',  'stats'),
        ('stats/home_doryoku.csv',  'stats'),
        ('stats/home_terastal.csv', 'stats'),
